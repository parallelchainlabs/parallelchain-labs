...
export default function LatestBlogPosts() {
  const blogPosts = [
    ...
    {
      badge: "Architecture",
      title: "Building Resilient Microservices with Next.js & Node.js",
      desc: "Learn how to architect high-throughput APIs and scalable backend services.",
      date: "May 8, 2024",
      readTime: "7 min read",
    ...
    {
      badge: "UI/UX Design",
      title: "Design Systems: Scaling Consistency Across Web & Mobile",
      desc: "How a unified component library accelerates product development and brand identity.",
      date: "Apr 20, 2024",
      readTime: "4 min read",
